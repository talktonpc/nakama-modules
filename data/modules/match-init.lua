...
nk.register_rpc(create_or_join_match, "rpc.machoo.world.join-v0.0")
nk.register_rpc(rcp_account_update, "rpc.machoo.account.update-v0.0")

nk.register_rpc(get_world_id, "rpc.machoo.world.get-world-id-v0.0")
nk.register_rpc(register_character_name, "rpc.machoo.world.register-character-name-v0.0")
nk.register_rpc(remove_character_name, "rpc.machoo.world.remove-character-name-v0.0")

...
nk.logger_info(" ============================================================ ")
nk.logger_info(" module: world_rpc ")
nk.logger_info(" ============================================================ ")
...
function world_control.match_init(_, _)
    ...
    nakama.logger_info(" module: world_rpc - match_init ...")
...
function world_control.match_join_attempt(_, _, _, state, presence, _)
    ...
    nakama.logger_info(" module: world_rpc - match_join_attempt ...")
...
function world_control.match_join(_, dispatcher, _, state, presences)
    ...
    nakama.logger_info(" module: world_rpc - match_join ...")
...
function world_control.match_leave(_, _, _, state, presences)
    ...
    nakama.logger_info(" module: world_rpc - match_leave ...")
